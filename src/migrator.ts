...
export const supportedComponentProps = ["name", "components", "methods", "mixins", "store", "props", "data", "computed", "ssrPrefetch", "metaInfo"]; // @Component properties, empty ignored. e.g. props: {}
